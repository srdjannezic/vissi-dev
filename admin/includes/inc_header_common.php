...
<script src="<?php echo DOCBASE; ?>js/plugins/angular.min.js"></script>
...
<script src="<?php echo DOCBASE.ADMIN_FOLDER; ?>/js/custom.js"></script>

<script src="<?php echo DOCBASE; ?>js/application.js"></script>
