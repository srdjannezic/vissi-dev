...
$(document).ready(function(){
    ...
    // Datepicker FROM date
        $(function() {
            $("#fromDate-holder,#fromDate-holder1").datepicker({
                ...
                onSelect: function(date) {
                    $("#from_picker,#from_picker1").attr('value',date);
        ...
        $(document).on('click', function(event) {
            if (!$(event.target).closest('.form-control,.ui-datepicker-prev, .ui-datepicker-next').length) {
                // Hide the menus.
                $('#fromDate-holder,#fromDate-holder1,#fromDatePopUp-holder,#toDatePopUp-holder').hide();
            }
        });
        ...
        $(function() {
            $("#toDate-holder,#toDate-holder1").datepicker({
                ...
                dateFormat: 'yy-mm-dd',
                onSelect: function(date) {
                    $("#to_picker, #to_picker1").attr('value',date);
        ...
        $(function() {
            $(".fromDatePopUp-holder").datepicker({
                startDate: new Date(),
                rangeSelect: true,
                dateFormat: 'yy-mm-dd',
                onSelect: function(date) {
                    $(".from-popup").attr('value',date);
                    $(".fromDatePopUp-holder").hide();
                    $(this).closest('form').addClass('selected');
                }
            }).position({
                my: "center top",
                at: "center bottom",
                of: $(".fromDatePopUp-holder"),
                collision: "flipfit"
            }).hide();
            $(".from-popup").focus(function() {
                $(".fromDatePopUp-holder").show();
            })
        });

        $(function() {
            $(".toDatePopUp-holder").datepicker({
                startDate: new Date(),
                rangeSelect: true,
                dateFormat: 'yy-mm-dd',
                onSelect: function(date) {
                    $(".to-popup").attr('value',date);
                    $(".toDatePopUp-holder").hide();
                    $(this).closest('form').addClass('selected');
                }
            }).position({
                my: "center top",
                at: "center bottom",
                of: $(".toDatePopUp-holder"),
                collision: "flipfit"
            }).hide();
            $(".to-popup").focus(function() {
                $(".toDatePopUp-holder").show();
            })
        });
 ...
 //    });
    ...
    gscript.src = '//maps.google.com/maps/api/js?callback=gmaps_callback&key=AIzaSyBzBcftAvuuLop-MgMB7aHNf4G7aIwkUaw';
	if($('meta[name="gmaps_api_key"]').length) gscript.src += '&key=AIzaSyBzBcftAvuuLop-MgMB7aHNf4G7aIwkUaw';
...
function gmaps_callback(){
    ...
    if($('#'+gmaps_id).length){
        ...
        var apikey = 'AIzaSyBzBcftAvuuLop-MgMB7aHNf4G7aIwkUaw';
        /*var locations = [
            ...
            if(locations[i][2] !== undefined && locations[i][3] !== undefined){
                ...
                (function(content){
                    ...
                    marker = new google.maps.Marker({
                        position: myLatlng,
                        icon:{url:image, scaledSize: new google.maps.Size(70, 70)},	
                        title: overlayTitle,
                        map: map
                    });
