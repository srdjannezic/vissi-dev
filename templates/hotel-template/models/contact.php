...
if(isset($_POST['send'])){
    ...
    $mobile = html_entity_decode($_POST['mobile'], ENT_QUOTES, 'UTF-8');
    $email = $_POST['email'];
        ...
        <section class="contact__main">
            ...
            <div class="alert alert-danger" style="display:none;"></div>
                ...
                <div class="contact__form">
                    <form method="post" action="<?php echo DOCBASE ?>send-mail" id="contact-form">
                        <div class="form-part">

                            <div class="input-wrapper">
                                <input type="text" name="name" placeholder="<?php echo $texts['LASTNAME']." ".$texts['FIRSTNAME']; ?> *" class="required" value="">
                            </div>
                            <div class="field-notice" rel="name"></div>

              
                            <div class="input-wrapper">
                                <input type="text" name="email" placeholder="<?php echo $texts['EMAIL']; ?> *" class="required" value="">
                            </div>
                            ...
                            <div class="input-wrapper">
                                <input type="text" name="phone" placeholder="<?php echo $texts['PHONE']; ?> *" class="required" value="">
                            </div>
                            <div class="field-notice" rel="phone"></div>
                            <div class="form-group">
                                <div class="input-wrapper">
                                    <input type="text" name="subject" value="" placeholder="<?php echo $texts['SUBJECT']; ?> *" class="required">
                                </div>
                    ...
                    <div class="hotBox" itemscope itemtype="http://schema.org/Corporation">
                        ...
                        <address>
                            <p>
                                ...
                                <?php if(PHONE != '') : ?><span class="fas fa-fw fa-phone"></span> <span itemprop="telephone" dir="ltr"><?php echo PHONE; ?></span><br><span itemprop="telephone" dir="ltr"><?php echo MOBILE; ?></span><br/><?php endif; ?>
